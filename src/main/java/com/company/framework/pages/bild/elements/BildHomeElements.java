package com.company.framework.pages.bild.elements;
 ...
 * 
 * This class contains all the element locators for the BILD home page.
 * Separated from actions and verifications following Single Responsibility Principle.
 */
public class BildHomeElements {
    ...
    // =================== ELEMENT GETTERS ===================
    // Required by dependent classes for clean access patterns
