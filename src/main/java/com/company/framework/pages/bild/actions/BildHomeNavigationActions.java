package com.company.framework.pages.bild.actions;
 ...
 * 
 * This class is responsible for all navigation-related actions on the BILD home page.
 * Follows Single Responsibility Principle - only navigation logic.
 * 
 * Moved to actions package for better organization and separation of concerns.
 */
public class BildHomeNavigationActions implements INavigationActions {
        ...
        switch (menuName.toLowerCase()) {
            ...
            default:
                ...
                throw new IllegalArgumentException("Menu '" + menuName + "' is not recognized. " +
                    "Available menus: home, sport, bildplay, bildki, more, search, premium");
        }
    }
    ...
    public void refresh() {
        ...
        // Implementation can be added based on app-specific refresh mechanisms
    }
