 ...
 * 
 * This class is responsible for all search-related actions on the BILD home page.
 * Updated to use new BildAppLocators structure and moved to actions package
