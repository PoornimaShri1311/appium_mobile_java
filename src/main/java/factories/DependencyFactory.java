...
import strategies.ExplicitWaitStrategy;
...
public class DependencyFactory {
    ...
    public IWaitStrategy getWaitStrategy() {
        if (waitStrategy == null) {
            try {
                waitStrategy = new strategies.ExplicitWaitStrategy(driverManager, config.ApplicationConstants.TIMEOUT_EXPLICIT_WAIT);
            } catch (Exception e) {
    ...
    public IPageActions getPageActions() {
        if (pageActions == null) {
            try {
                ...
                if (strategy != null) {
                    pageActions = new actions.PageActions(strategy);
                }
            } catch (Exception e) {
